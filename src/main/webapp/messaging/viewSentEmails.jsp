...
<logic:present name="sender">
	<fr:view name="sender" schema="org.fenixedu.messaging.domain.Sender.info">
	...
	<fr:view name="messages" schema="org.fenixedu.messaging.domain.Message.list">
		<fr:layout name="tabular">
...
<logic:present name="sendersGroups">
	<fr:view name="sendersGroups" schema="org.fenixedu.messaging.domain.Sender.list"  >
		<fr:layout name="tabular">
...
<logic:present name="sendersGroupsCourses">
	<fr:view name="sendersGroupsCourses" schema="org.fenixedu.messaging.domain.Sender.list.courses"  >
		<fr:layout name="tabular">
			<fr:property name="classes" value="tstyle2 thlight mtop05"/>
			<fr:property name="columnClasses" value=",,aleft,"/>
			<fr:property name="link(view)" value="/viewSentEmails.do?method=viewSentEmails"/>
...
<logic:present name="searchSendersBean">
	...
	<logic:notEmpty name="searchResult">
		<fr:view name="searchResult" schema="org.fenixedu.messaging.domain.Sender.list"  >
			<fr:layout name="tabular">
				<fr:property name="classes" value="tstyle2 thlight mtop05"/>
				<fr:property name="columnClasses" value=",,aleft,"/>
				<fr:property name="link(view)" value="/viewSentEmails.do?method=viewSentEmails"/>
